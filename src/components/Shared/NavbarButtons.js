...
import { Container, Form, FormGroup, Input, Label, Modal, ModalBody, Row, Col, Dropdown, DropdownMenu, DropdownToggle } from "reactstrap";
              ...
              >
                <Form>
                  <input
                    ...
                    placeholder={t('material_table_localization.toolbar.searchTooltip', { returnObjects: true })}
                  />
                </Form>
              </DropdownMenu>
            </Dropdown>
