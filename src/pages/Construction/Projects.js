...
import big_family from "../../assets/images/big-family.jpg"
//Import Icons
          ...
          <Row>
            <Col  lg={4} md={6}>
              <div className="section-title sticky-bar position-sticky ">
                ...
                Siz ve sevdiklerinizin en rahat edeceği şekilde hizmet alabilmesi için yüz yüze ve online şeklinde danışmanlık hizmeti vermekteyim. 
                </p>
                <img style={{width:'100%', height:'100%', opacity:'50%  '}} src={big_family}></img>
              </div>
            ...
            <Col lg={8} md={6}>
              ...
              <Row className="projects-wrapper ">
               <div className="d-flex m-5">
                          ...
                          <CardBody className="p-0">
                            ...
                            <div className="content p-4">
                              ...
                              <h6 className="text-muted tag mb-0">
                               Siz ve sevdiklerinizin ihtiyaç duydukları heran yanlarında olabilmek için uzaktan danışmanlık hizmeti
                              </h6>
                            </div>
                  ...
                  lg={6}
                  xs={12}
                  className="mt-4 pt-2 offices px-2"
                >
                  <FadeIn delay={100}>
                    <Card className="border-0 work-container work-classic shadow overflow-hidden">
                      <CardBody className="p-0">
                        ...
                        <div className="content p-4">
                          ...
                          <h6 className="text-muted tag mb-0">
                           Kendinizi evinizdeki gibi hissedeceğiniz sıcak ofimizde yüz yüze danışmanlık hizmeti v
                          </h6>
                        </div>
